...
def home():
    ...
    try:
        ...
        return redirect(url_for("login",msg="session expired , lets try to login"))
    except jwt.exceptions.DecodeError:
        return redirect(url_for("login",msg="something wrong with your loggin"))
